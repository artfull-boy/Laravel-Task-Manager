...
export default function Show({ user, queryParams, tasks }) {
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div>
                            <img
                                src={user.image_path.startsWith("http") ? user.image_path : "/storage/" + user.image_path}
                                alt=""
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                            {tasks.data.length>0 ? (
                                ...
                                <p className="p-[40px] text-center text-white">No Tasks in this user</p>
                            )}
                        </div>
                    </div>
                </div>
