...
export default function Edit(project) {
    const { data, setData, post , errors } = useForm({
        image_path: "", // Set to null initially
        name: project.name,
        status: project.status,
        description: project.description,
        due_date: new Date(project.due_date).toISOString().split('T')[0],
        _method:"PUT",
    });
                        ...
                        <div className="p-6 text-gray-900 dark:text-gray-100 overflow-auto">
                            ...
                            >
                                ...
                                <div className="mt-4">
                                    ...
                                    />
                                    <img src={project.image_path.startsWith("http") ? project.image_path : "/storage/" + project.image_path} className="mt-[30px] w-[100px] "></img>
